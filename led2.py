...
#speichert die Werte aller Segment Anzeigen (max. 8)
...
def display(dig, value):
    ...
    values['8'] = 0b11111110
    values['9'] = 0b11011110
    values[-1]  = 0b00000000 #leeres Zeichen
    values[' '] = 0b00000000
    values['A'] = 0b11101110
    values['b'] = 0b11111000
    values['C'] = 0b01110010
    ...
    #alle Segment Anzeigen durchgehen
    for x in range(8):
        if (values[value]) & (1 << x) :
...
def showvalue(value):
    ...
    #alle nicht belegten Anzeigen mit dem leeren Zeichen fuellen
    n = ([-1]*8 + n)[-8:]
    n.reverse()
    index = 7
    for i in n:
